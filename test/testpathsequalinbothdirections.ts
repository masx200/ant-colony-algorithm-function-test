...
export function testpathsequalinbothdirections() {
    ...
    console.assert(
        ispathsequalinbothdirections([0, 1, 2, 3, 4], [0, 4, 3, 2, 1])
    );
    console.assert(
        ispathsequalinbothdirections([4, 0, 1, 2, 3], [0, 4, 3, 2, 1])
    );
    console.assert(
        ispathsequalinbothdirections([1, 2, 3, 4, 0], [4, 3, 2, 1, 0])
    );
    console.assert(
        ispathsequalinbothdirections([2, 3, 4, 0, 1], [4, 3, 2, 1, 0])
    );
